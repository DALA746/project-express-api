  ...
  res.send({
    ...
    description: {
      endpoint1: {
        ...
        'Returns shows by a specific type (tv shows or movies), replace text inside <> with your text':
          '/shows?type=<type>',
        'Returns shows by a specific year, replace text inside <> with your text':
          '/shows?year=<year here>',
        'Set limit and page of a response, replace text inside <> with your text':
          '/shows?page=<page number>&limit=<limit number>'
      },
      endpoint2: {
